...
def _get_mouth_frames(video_path):
    """
    Given .../participant/word1/videos/video_0/
    Returns sorted list of PNG paths inside .../mouths/
    """
...
def main():
    ...
    print(os.path.isdir(root), root)

    dataset = KinectMouthDataset(
        root=root,
        T=16,
        H=96,
        W=96,
        include_prefixes=["word"]
    )
